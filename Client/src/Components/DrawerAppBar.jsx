  ...
  return (
    <Box sx={{display: 'flex', justifyContent: 'space-between'}}>
      ...
      <AppBar component="nav">
        <Toolbar
          style={{
            background: 'linear-gradient(45deg, rgb(91 108 196), rgba(0, 0, 0, 0.223))',
          }}
        >
          <Link
            to="/"
          ...
          {teamName&&<Avatar sx={{bgcolor: green[900],width:'auto',padding:2,fontSize:'14px',display: {xs: 'none', sm: 'block'},}} variant="rounded">
